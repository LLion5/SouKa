...
public class XEditText extends AppCompatEditText {
    ...
    private int[] pattern; // pattern to separate. e.g.: mSeparator = "-", pattern = [3,mine,mine] -> xxx-xxxx-xxxx
     ...
     *
     * @param pattern   e.g. pattern:{mine,mine,mine,mine}, separator:"-" to xxxx-xxxx-xxxx-xxxx
